"""
Day Simulation Coordinator

Coordinates the simulation of a single day in the NFL season by:
...
class DaySimulationCoordinator:
    """
    Coordinates daily simulation workflow.
    ...
    def __init__(self, calendar: CalendarComponent, event_db: EventDatabaseAPI):
        """
        Initialize day simulation coordinator.
