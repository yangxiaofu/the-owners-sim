...
class SeasonDataModel:
    ...
    def _get_current_season_type(self) -> str:
        ...
        try:
            ...
            print(f"[WARNING SeasonDataModel] Could not determine season_type: {e}, using 'regular_season'")
            return 'regular_season'  # Safe fallback

    def get_team_standings(self) -> Dict[str, Any]:
        """
        Get current standings from database for the current phase.

        Queries the database for standings matching the current season phase:
        ...
        Returns:
            ...
            - No standings data exists for dynasty/season/phase
