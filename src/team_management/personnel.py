...
class TeamRosterGenerator:
    ...
    def _generate_quarterbacks(cls, team: Team) -> List[Player]:
        ...
        return [
            Player(f"{team.city} Starting QB", 1, Position.QB, {"overall": random.randint(75, 95)}),
            Player(f"{team.city} Backup QB", 12, Position.QB, {"overall": random.randint(65, 80)}),
            Player(f"{team.city} 3rd String QB", 15, Position.QB, {"overall": random.randint(55, 70)})
        ]
    ...
    def _generate_running_backs(cls, team: Team) -> List[Player]:
        ...
        return [
            Player(f"{team.city} Starting RB", 21, Position.RB, {"overall": random.randint(75, 90)}),
            Player(f"{team.city} Backup RB", 32, Position.RB, {"overall": random.randint(65, 80)}),
            Player(f"{team.city} 3rd Down RB", 28, Position.RB, {"overall": random.randint(60, 75)}),
            Player(f"{team.city} Fullback", 44, Position.FB, {"overall": random.randint(65, 80)})
        ]
    ...
    def _generate_wide_receivers(cls, team: Team) -> List[Player]:
        ...
        return [
            Player(f"{team.city} WR1", 11, Position.WR, {"overall": random.randint(80, 95)}),
            Player(f"{team.city} WR2", 13, Position.WR, {"overall": random.randint(75, 85)}),
            Player(f"{team.city} WR3", 17, Position.WR, {"overall": random.randint(70, 82)}),
            Player(f"{team.city} WR4", 19, Position.WR, {"overall": random.randint(65, 75)}),
            Player(f"{team.city} WR5", 16, Position.WR, {"overall": random.randint(60, 70)}),
            Player(f"{team.city} WR6", 14, Position.WR, {"overall": random.randint(55, 65)})
        ]
    ...
    def _generate_tight_ends(cls, team: Team) -> List[Player]:
        ...
        return [
            Player(f"{team.city} Starting TE", 87, Position.TE, {"overall": random.randint(75, 90)}),
            Player(f"{team.city} TE2", 85, Position.TE, {"overall": random.randint(65, 80)}),
            Player(f"{team.city} TE3", 81, Position.TE, {"overall": random.randint(60, 75)})
        ]
    ...
    def _generate_offensive_line(cls, team: Team) -> List[Player]:
        ...
        return [
            Player(f"{team.city} LT", 73, Position.LT, {"overall": random.randint(75, 90)}),
            Player(f"{team.city} LG", 67, Position.LG, {"overall": random.randint(70, 85)}),
            Player(f"{team.city} Center", 55, Position.C, {"overall": random.randint(75, 88)}),
            Player(f"{team.city} RG", 65, Position.RG, {"overall": random.randint(70, 85)}),
            Player(f"{team.city} RT", 71, Position.RT, {"overall": random.randint(75, 90)}),
            # Backup linemen
            Player(f"{team.city} OL6", 74, Position.LT, {"overall": random.randint(60, 75)}),
            Player(f"{team.city} OL7", 68, Position.LG, {"overall": random.randint(60, 75)}),
            Player(f"{team.city} OL8", 63, Position.C, {"overall": random.randint(60, 75)})
        ]
    ...
    def _generate_defensive_line(cls, team: Team) -> List[Player]:
        ...
        return [
            Player(f"{team.city} LE", 91, Position.DE, {"overall": random.randint(75, 90)}),
            Player(f"{team.city} RE", 94, Position.DE, {"overall": random.randint(75, 90)}),
            Player(f"{team.city} DT1", 93, Position.DT, {"overall": random.randint(75, 88)}),
            Player(f"{team.city} NT", 98, Position.NT, {"overall": random.randint(70, 85)}),
            Player(f"{team.city} DT2", 95, Position.DT, {"overall": random.randint(65, 80)}),
            Player(f"{team.city} DE3", 92, Position.DE, {"overall": random.randint(60, 75)})
        ]
    ...
    def _generate_linebackers(cls, team: Team) -> List[Player]:
        ...
        return [
            # 4-3 Linebackers
            Player(f"{team.city} Mike LB", 54, Position.MIKE, {"overall": random.randint(75, 90)}),
            Player(f"{team.city} Sam LB", 52, Position.SAM, {"overall": random.randint(75, 88)}),
            Player(f"{team.city} Will LB", 58, Position.WILL, {"overall": random.randint(75, 88)}),
            
            # 3-4 Linebackers  
            Player(f"{team.city} ILB1", 56, Position.ILB, {"overall": random.randint(70, 85)}),
            Player(f"{team.city} ILB2", 57, Position.ILB, {"overall": random.randint(65, 80)}),
            Player(f"{team.city} OLB1", 51, Position.OLB, {"overall": random.randint(75, 85)}),
            Player(f"{team.city} OLB2", 59, Position.OLB, {"overall": random.randint(70, 80)})
        ]
    ...
    def _generate_defensive_backs(cls, team: Team) -> List[Player]:
        ...
        return [
            Player(f"{team.city} CB1", 24, Position.CB, {"overall": random.randint(80, 92)}),
            Player(f"{team.city} CB2", 22, Position.CB, {"overall": random.randint(75, 88)}),
            Player(f"{team.city} Nickel CB", 26, Position.NCB, {"overall": random.randint(70, 85)}),
            Player(f"{team.city} Dime CB", 25, Position.NCB, {"overall": random.randint(65, 80)}),
            Player(f"{team.city} FS", 31, Position.FS, {"overall": random.randint(75, 90)}),
            Player(f"{team.city} SS", 33, Position.SS, {"overall": random.randint(75, 88)}),
            Player(f"{team.city} CB3", 29, Position.CB, {"overall": random.randint(65, 80)}),
            Player(f"{team.city} CB4", 27, Position.CB, {"overall": random.randint(60, 75)}),
            Player(f"{team.city} S3", 37, Position.FS, {"overall": random.randint(60, 75)})
        ]
    ...
    def _generate_specialists(cls, team: Team) -> List[Player]:
        ...
        return [
            Player(f"{team.city} Kicker", 4, Position.K, {"overall": random.randint(70, 85)}),
            Player(f"{team.city} Punter", 8, Position.P, {"overall": random.randint(70, 85)}),
            Player(f"{team.city} Long Snapper", 46, Position.LS, {"overall": random.randint(65, 80)}),
            Player(f"{team.city} Holder", 18, Position.H, {"overall": random.randint(60, 75)}),  # Usually backup QB/P
            Player(f"{team.city} Kick Returner", 23, Position.KR, {"overall": random.randint(70, 85)}),
            Player(f"{team.city} Punt Returner", 10, Position.PR, {"overall": random.randint(70, 85)})
        ]