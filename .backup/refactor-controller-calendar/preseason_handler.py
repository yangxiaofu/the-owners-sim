...
class PreseasonHandler:
    ...
    def advance_day(self) -> Dict[str, Any]:
        ...
        print(f"\n{'='*80}")
        print(f"[PRESEASON_HANDLER] advance_day() CALLED")
        print(f"{'='*80}")
        print(f"  Season year: {self.season_year}")
        print(f"  Current date (before advance): {self.calendar.get_current_date()}")
        ...
        # DIAGNOSTIC: After calendar advance
        print(f"[PRESEASON_HANDLER] Calendar advanced to: {current_date}")
        print(f"")
